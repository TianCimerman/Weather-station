...
def get_temp():
    flux_query = '''
        ...
        |> filter(fn: (r) => r["_measurement"] == "climate")  // Filter by the measurement
        |> filter(fn: (r) => r["_field"] == "temperature" or r["_field"] == "humidity" or r["_field"] == "humidity_2"or r["_field"] == "temperature_2")  // Filter for specific fields
